        ...
        <div className="flex-1 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
          <div>
            <div className="flex items-center justify-between mb-1">
              <div>
                <h2 className="text-lg font-semibold mb-2 div-text">Shipping zones</h2>
                <p className="text-gray-600 dark:text-gray-400 div-text">
            ...
            {shippingZones.map((zone, index) => (
              <div key={index} className="mb-8 p-4  rounded-lg mt-6 border-dark div-dark div-text">
                ...
                <table className="w-full border-collapse border border-dark">
                  <thead>
                    <tr className="text-left text-gray-600 div-text">
                  ...
                  <tbody>
                    {zone.rates.map((rate, idx) => (
                      <tr key={idx} className="border-t border-dark">
                ...
                <button className="mt-3 text-indigo-600 hover:underline bg-indigo-100 p-2 dark:bg-indigo-400">Add Rate</button>
              </div>
            ))}
          </div>
        </div>
