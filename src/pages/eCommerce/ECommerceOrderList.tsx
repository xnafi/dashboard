...
const orders = [
  {
    ...
    customer: { name: "Cristine Easom", email: "ceasomw@theguardian.com" },
    payment: "Pending",
    status: "Delivered",
    method: "mastercard",
    lastDigits: "2356",
  },
  {
    ...
    customer: { name: "Fayre Screech", email: "fscreechs@army.mil" },
    payment: "Failed",
    status: "Delivered",
    method: "mastercard",
    lastDigits: "2077",
  },
  {
    ...
    customer: { name: "Pauline Pfaffe", email: "ppfaffe1@wikia.com" },
    payment: "Cancelled",
  ...
  },
  {
    ...
    customer: { name: "Maurits Nealey", email: "mnealey@japanpost.jp" },
    payment: "Paid",
    status: "Dispatched",
    method: "mastercard",
    lastDigits: "1555",
