      ...
      <div className="flex gap-6 ">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 w-3/4 dark:bg-gray-800  dark:text-gray-300">
          ...
          <div className="bg-gray-100 p-3 rounded-lg mb-6 dark:bg-gray-700  dark:text-gray-300">
            <p className="font-semibold mb-2 dark:text-gray-300">Invoice #3492</p>
  ...
  <div className="space-y-2">
    ...
    <div className="flex gap-7">
      ...
      <span>BR91905</span>
          ...
          {/* Table */}
          <table className="w-full border-collapse mb-6 border dark:border-gray-300">
            <thead>
              <tr className="bg-gray-100 text-left text-gray-300 dark:bg-gray-800  dark:text-gray-300 border dark:border-gray-300">
            ...
            <tbody className="divide-y dark:border-gray-300">
          ...
          <p className="mt-6 text-sm text-gray-600 text-start dark:text-gray-300">
            <span className="font-semibold dark:text-gray-300">Salesperson:</span> Tommy Shelby <br />
