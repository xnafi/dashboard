    ...
    <section className="bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <button className="inline-block px-4 py-1 mb-4 text-sm font-medium text-indigo-500 bg-blue-100 rounded-full">
            Contact Us
          </button>
        ...
        <div className="flex flex-col lg:flex-row bg-white rounded-lg">
          ...
          <div className="lg:w-1/2 relative p-6 flex flex-col items-center border-b lg:border-b-0 lg:border-r bg-gray-50 gap-4 border-gray-200">
            {/* Decorative Top Border */}
            <div
              className="absolute top-0 left-0 w-40 h-28 bg-no-repeat bg-contain"
              style={{
                backgroundImage: `url('https://i.postimg.cc/fTBKWTYr/Border.png')`,
              }}
            ></div>
            <img
          ...
          <div className="lg:w-1/2 p-6 h-full shadow-lg">
            ...
            <form className="space-y-6">
              ...
              <textarea
                ...
                className="border border-gray-300 rounded-lg p-3 w-full h-72 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                rows={4}
              />
              <button
                type="submit"
